            ...
            <div class="mainwrapper">
                <div class="leftpanel">
                    ...
                    <ul class="nav nav-pills nav-stacked">
                        ...
                        <li class="active"><a href="member/chart"><i class="fa fa-signal"></i> <span>Charts</span></a></li>
                        ...
                        <div class="media">
                            ...
                            <div class="media-body pull-left">
                                <ul class="breadcrumb hide-for-520px">
                                    <li><a href=""><i class="fa fa-signal"></i></a></li>
                                    <li>Chart</li>
                                </ul>
                                <h4>Chart</h4>
                            </div>
                            <div id="stock_list" class="pull-right nomargin"></div>
