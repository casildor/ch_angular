            ...
            <div class="mainwrapper">
                <div class="leftpanel">
                    ...
                    <ul class="nav nav-pills nav-stacked">
                        <li class="active"><a href="member/dashboard"><i class="fa fa-home"></i> <span>Dashboard</span></a></li>
                ...
                <div class="mainpanel">
                    <div class="pageheader">
                        <div class="media">
                            ...
                            <div class="pull-right">
                            	<span id="clock" class="btn btn-default btn-sm hide">Refresh: 15:00</span>
                            </div>
                        </div><!-- media -->
                    </div><!-- pageheader -->
                    ...
                    <div class="contentpanel">
                        ...
                        <div id="loading_view" class="text-center mt20 hide"><h4>Loading Stocks</h4><img src="images/loader20.gif"></div>

                        <div id="stock_panel"></div>
